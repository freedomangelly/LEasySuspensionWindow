...
import com.lightyear.librarysuspensionwindow.draggable.BaseDraggable;
...
public class LEasyFloatToast<X extends LEasyFloatToast<?>> {
     ...
     * 创建一个局部悬浮窗
     */
    public LEasyFloatToast(Activity activity) {
     ...
     * 创建一个全局悬浮窗
     */
    public LEasyFloatToast(Application application) {
    ...
    private LEasyFloatToast(Context context) {
        mContext = context;
